<<<<<<< HEAD:Converter/Converter_portable.ahk
﻿;
;
;
;
...
dev_sborka = https://raw.githubusercontent.com/Apik21/Converter/master/sborka.num ;Сборка с сайта
...
{
	UrlDownloadToFile, https://raw.githubusercontent.com/Apik21/Converter/master/sborka.num, "%A_Temp%\DBFFC.tmp\sborka.num"
	ELM(%ErrorLevel%, Ошибка загрузки, 1)
	FileRead, new_sborka, "%A_Temp%\DBFFC.tmp\sborka.num"
	ELM(%ErrorLevel%, Ошибка чтения, 1)
	If new_sborka > sborka 
	{
		MsgBox, 52, Обновление, Найдена новая версия программы.`n Текущая версия программы - %Vers%.%sborka%,`n Новая версия программы - %Vers%.%sborka2%.`n Скачать обновление??
		IfMsgBox Yes
		{
...
Update:
UrlDownloadToFile, %dev_sborka%, %A_Temp%\DBFFC.tmp\number.txt
...
ExitApp
>>>>>>> 20022a08ea0cae021c699003aa5ade2a722b9dc5:Converter_portable.ahk
